...
//                         USART_ROUTE_CLKPEN | MICROSD_LOC;
  ...
  MICROSD_USART->ROUTELOC0 = (CONFIG_MICROSD_USART->ROUTELOC0 & (~_USART_ROUTELOC0_CLKLOC_MASK))
				| CONFIG_MICROSD_LOC_CLK;
	/* Set up CS pin */
  MICROSD_USART->ROUTELOC0 = (CONFIG_MICROSD_USART->ROUTELOC0 & (~_USART_ROUTELOC0_CSLOC_MASK))
					| CONFIG_MICROSD_LOC_CS;
	/* Set up RX pin */
  MICROSD_USART->ROUTELOC0 = (CONFIG_MICROSD_USART->ROUTELOC0 & (~_USART_ROUTELOC0_RXLOC_MASK))
				| CONFIG_MICROSD_LOC_RX;
	/* Set up TX pin */
  MICROSD_USART->ROUTELOC0 = (CONFIG_MICROSD_USART->ROUTELOC0 & (~_USART_ROUTELOC0_TXLOC_MASK))
			| CONFIG_MICROSD_LOC_TX;
	//route all
  MICROSD_USART->ROUTEPEN |= USART_ROUTEPEN_CLKPEN | USART_ROUTEPEN_RXPEN | USART_ROUTEPEN_TXPEN;
  ...
  /* IO configuration */
  GPIO_PinModeSet(MICROSD_MOSIPORT, MICROSD_MOSIPIN, gpioModePushPull, 0);  /* MOSI */
  GPIO_PinModeSet(MICROSD_MISOPORT, MICROSD_MISOPIN, gpioModeInputPull, 1); /* MISO */
  GPIO_PinModeSet(MICROSD_CSPORT, 	MICROSD_CSPIN,   gpioModePushPull, 1);  /* CS */
  GPIO_PinModeSet(MICROSD_CLKPORT, 	MICROSD_CLKPIN,  gpioModePushPull, 0);  /* CLK */
}
...
void MICROSD_Deinit(void)
{
  ...
  GPIO_PinModeSet(MICROSD_MOSIPORT, MICROSD_MOSIPIN, gpioModeDisabled, 0);  /* MOSI */
  GPIO_PinModeSet(MICROSD_MISOPORT, MICROSD_MISOPIN, gpioModeDisabled, 0);  /* MISO */
  GPIO_PinModeSet(MICROSD_CSPORT, MICROSD_CSPIN,   gpioModeDisabled, 0);  /* CS */
  GPIO_PinModeSet(MICROSD_CLKPORT, MICROSD_CLKPIN,  gpioModeDisabled, 0);  /* Clock */
}
...
{
  GPIO_PinOutSet(MICROSD_CSPORT, MICROSD_CSPIN);
  //GPIO->P[ MICROSD_CSPORT ].DOUTSET = 1 << MICROSD_CSPIN; /* CS pin high. */
...
{
  GPIO_PinOutClear(MICROSD_CSPORT, MICROSD_CSPIN);
  //GPIO->P[ MICROSD_CSPORT ].DOUTCLR = 1 << MICROSD_CSPIN; /* CS pin low. */
  if (WaitReady() != 0xFF) {
    MICROSD_Deselect();
    return 0;
  }
