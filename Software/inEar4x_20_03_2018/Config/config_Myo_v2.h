/******************************************************************************
 * @file config_Myo_v2.h
 * @brief Configuration File for Myo v1 Project
 ...
 *
 * *****************************************************************************/
#ifndef CONFIG_MYO_V2_H_
#define CONFIG_MYO_V2_H_
#include "../config.h"
#if CONFIGSYSTEM==MYOV2

#define CONFIG_VERSION              60120           //Last digit of year, Month, Day
