 ...
 * @brief Configuration File for Default Projects
...
#include "../config.h"
#if CONFIGSYSTEM==DEFAULT

//#define CONFIG_DEBUG_PRINTOUT_ENABLE			1							// Enables Print Out on SWO for Debugging

/* Versioning */
#define CONFIG_VERSION							60101						//Last digit of year, Month, Day
...
#define CONFIG_SYSTEM_TYPE						1

// TODO CLEANUP!!!!
#define CONFIG_BUFFERSIZE_ACC					1024	// in bytes
#define CONFIG_BUFFERSIZE_GYRO					1024	// in bytes
#define CONFIG_BUFFERSIZE_TEMP					1024	// in bytes
#define CONFIG_BUFFERSIZE_PRESS					768		// in bytes
#define CONFIG_BUFFERSIZE_ADC					1024	// in bytes
#define CONFIG_SYSTEM_HFRCO_FREQ				14000000
#define CONFIG_SYSTEM_HFXO_FREQ					48000000
#define Config_prescaled	CONFIG_SYSTEM_HFRCO_FREQ/CONFIG_TIMER0_PRESCALE //TODO doesnt work :(
...
#define CONFIG_SAVEUNISENS_BMP280_PRESS			0							// Save PRESSURE of BMP280 to Unisens File on SD-Card
#define CONFIG_SAVEUNISENS_BMP280_TEMP			0							// Save TEMP of BMP280 to Unisens File on SD-Card
