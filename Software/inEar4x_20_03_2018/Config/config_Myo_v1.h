 ...
 *
 * *****************************************************************************/
#ifndef CONFIG_MYO_V1_H_
#define CONFIG_MYO_V1_H_
#include "../config.h"
#if CONFIGSYSTEM==MYOV1

#define CONFIG_VERSION              51201           //Last digit of year, Month, Day
