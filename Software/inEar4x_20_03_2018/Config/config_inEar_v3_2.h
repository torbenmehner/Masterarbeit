 ...
 *
 * *****************************************************************************/
#ifndef CONFIG_INEAR_V3_2_H_
#define CONFIG_INEAR_V3_2_H_
#include "../config.h"
 ...
 */
#define CONFIG_SYNC_RX_PIN						6							// Pin for BLE RX
#define CONFIG_SYNC_TX_PIN						10							// Pin for BLE TX

/*
 * Configuration for SAMPLE time
 */
#define CONFIG_SAMPLE_TIMERCOUNT				6
...
#define CONFIG_LED_RED_PIN						2							// Pin for Red LED
#define CONFIG_LED_GREEN_PORT					gpioPortA					// Port for Green LED
#define CONFIG_LED_GREEN_PIN					0							// Pin for Green LED
#define CONFIG_LED_BLUE_PORT					gpioPortD					// Port for Blue LED
#define CONFIG_LED_BLUE_PIN						15							// Pin for Blue LED
...
#define CONFIG_BMI160_VCC_ENABLE				0
#define CONFIG_BMI_USART           				USART1
#define CONFIG_BMI_CMUCLOCK        				cmuClock_USART1
#define CONFIG_BMI_BAUDRATE						57600
#define CONFIG_BMI_LOC_CLK						USART_ROUTELOC0_CLKLOC_LOC17
#define CONFIG_BMI_LOC_CS						USART_ROUTELOC0_CSLOC_LOC30
#define CONFIG_BMI_LOC_RX						USART_ROUTELOC0_RXLOC_LOC16
#define CONFIG_BMI_LOC_TX						USART_ROUTELOC0_TXLOC_LOC18
#define CONFIG_BMI_PORT_CLK						gpioPortD
#define CONFIG_BMI_PIN_CLK						11
#define CONFIG_BMI_PORT_CS						gpioPortA
#define CONFIG_BMI_PIN_CS						1
#define CONFIG_BMI_PORT_RX						gpioPortD
#define CONFIG_BMI_PIN_RX						9
#define CONFIG_BMI_PORT_TX						gpioPortD
#define CONFIG_BMI_PIN_TX						10
#define CONFIG_BMI_PORT_VCC						0
#define CONFIG_BMI_PIN_VCC						0
...
/*
/*
 * Configuration SENSOR BMP280 SPI
 */
#define CONFIG_SPI_SENSOR_ENABLE				1

#define CONFIG_BMP280_ENABLE           			1
#define CONFIG_AFE44x0_ENABLE           		0
#define CONFIG_ADS129x_ENABLE           		0
#define CONFIG_BME680_ENABLE  					0
#define CONFIG_ADS1292_ENABLE           		0
...
#define CONFIG_SENSOR_CMUCLOCK        			cmuClock_USART0
	...
	#define CONFIG_ADS129x_RDY_PORT				gpioPortD
	#define CONFIG_ADS129x_RDY_PIN				12
	#define CONFIG_AFE44x0_RDY_PORT				gpioPortD
	#define CONFIG_AFE44x0_RDY_PIN				12
	#define CONFIG_ADS1292_RDY_PORT				gpioPortD
	#define CONFIG_ADS1292_RDY_PIN				13
...
#define CONFIG_SENSOR_LOC_CLK					USART_ROUTELOC0_CLKLOC_LOC20
#define CONFIG_SENSOR_LOC_CS					USART_ROUTELOC0_CSLOC_LOC18
#define CONFIG_SENSOR_LOC_RX					USART_ROUTELOC0_RXLOC_LOC3
#define CONFIG_SENSOR_LOC_TX					USART_ROUTELOC0_TXLOC_LOC8
#define CONFIG_SENSOR_PORT_CLK					gpioPortD
#define CONFIG_SENSOR_PIN_CLK					14
#define CONFIG_SENSOR_PORT_CS					gpioPortD
#define CONFIG_SENSOR_PIN_CS					13
#define CONFIG_SENSOR_PORT_RX					gpioPortA
...
#define CONFIG_SENSOR_PIN_TX					13
	...
	#define CONF_DEVICE_NUM  						0
#endif

#if CONFIG_AFE44x0_ENABLE
	#define CONF_DEVICE_NUM  						2
#endif
 ...
 */
#define CONFIG_BUTTON_PORT						gpioPortC					// Port for Button
#define CONFIG_BUTTON_PIN						8							// Pin for Button
...
#define CONFIG_MICROSD_ENABLE           		0
